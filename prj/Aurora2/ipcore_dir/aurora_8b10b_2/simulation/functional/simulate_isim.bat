...
vhpcomp -work work ..\..\example_design\traffic_gen_check\aurora_8b10b_2_frame_check.vhd
vhpcomp -work work ..\..\example_design\traffic_gen_check\aurora_8b10b_2_frame_gen.vhd   
