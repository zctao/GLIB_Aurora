...
vhpcomp -work work ..\..\example_design\traffic_gen_check\aurora8b10b_frame_check.vhd
vhpcomp -work work ..\..\example_design\traffic_gen_check\aurora8b10b_frame_gen.vhd   
