...
static void NetDecl_49934_0(char *t0)
{
    char t3[8];
    char t6[8];
    char *t1;
...
LAB2:    xsi_set_current_line(49934, ng0);
    t2 = (t0 + 784U);
    t4 = *((char **)t2);
    t2 = (t0 + 692U);
    t5 = *((char **)t2);
...
static void NetDecl_49935_1(char *t0)
{
    char t3[8];
    char t4[8];
    char t22[8];
...
LAB2:    xsi_set_current_line(49935, ng0);
    t2 = (t0 + 968U);
    t5 = *((char **)t2);
    memset(t4, 0, 8);
    t2 = (t5 + 4);
...
LAB34:    t160 = (t3 + 4);
    ...
    t163 = (~(t162));
    *((unsigned int *)t3) = t163;
    *((unsigned int *)t160) = 0;
    if (*((unsigned int *)t161) != 0)
        goto LAB36;

LAB35:    t168 = *((unsigned int *)t3);
    *((unsigned int *)t3) = (t168 & 1U);
    ...
    *((unsigned int *)t180) = (t182 | t176);
    xsi_driver_vfirst_trans_delayed(t170, 0, 0U, 50LL, 0);
    t183 = (t0 + 2632);
    *((int *)t183) = 1;
...
LAB36:    t164 = *((unsigned int *)t3);
    t165 = *((unsigned int *)t161);
    *((unsigned int *)t3) = (t164 | t165);
...
extern void secureip_m_00000000001478057831_0328391170_init()
{
	static char *pe[] = {(void *)NetDecl_49934_0,(void *)NetDecl_49935_1,(void *)implSig1_execute,(void *)implSig2_execute};
	xsi_register_didat("secureip_m_00000000001478057831_0328391170", "isim/FrameGenChk_tb_isim_beh.exe.sim/secureip/m_00000000001478057831_0328391170.didat");
