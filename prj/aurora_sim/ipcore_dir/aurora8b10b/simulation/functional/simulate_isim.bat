...
vlogcomp -work work ..\..\example_design\traffic_gen_check\aurora8b10b_frame_check.v
vlogcomp -work work ..\..\example_design\traffic_gen_check\aurora8b10b_frame_gen.v   
