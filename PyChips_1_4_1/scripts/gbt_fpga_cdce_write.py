...
#NOTE: 1 VCO step = ~1ns (1/960MHz)

cdce_settings[0] = 0xEB040320 # reg0 (out0=120MHz,LVDS,  phase shift  0 VCO steps)
#cdce_settings[0] = 0xEB840320 # reg0 (out0=240MHz,LVDS, phase shift  0 VCO steps)
#cdce_settings[0] = 0xEB840720 # reg0 (out0=240MHz,LVDS, phase shift  1 VCO steps)
#cdce_settings[0] = 0xEB840B20 # reg0 (out0=240MHz,LVDS, phase shift  2 VCO steps)
#cdce_settings[0] = 0xEB840F20 # reg0 (out0=240MHz,LVDS, phase shift  3 VCO steps)
cdce_settings[1] = 0xEB020321 # reg1 (out1=160MHz,LVDS)
cdce_settings[2] = 0xEB020302 # reg2 (out2=160MHz,LVDS)
#cdce_settings[3] = 0xEB840303 # reg3 (out3=240MHz,LVDS, phase shift  0 VCO steps)
#cdce_settings[3] = 0xEB840703 # reg3 (out3=240MHz,LVDS, phase shift  1 VCO steps)
#cdce_settings[3] = 0xEB840B03 # reg0 (out3=240MHz,LVDS, phase shift  2 VCO steps)
cdce_settings[3] = 0xEB840F03 # reg0 (out3=240MHz,LVDS,  phase shift  3 VCO steps)
