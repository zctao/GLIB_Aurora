...
##																													
## Additional Comments: 																							
## * Read and Write User PROM(MCS) file from/to user FLASH region (400000h-77FFFFh).
##																													
##===================================================================================================##
##===================================================================================================##
...
if arg_length == 3:	
	...
	if args[2] == "r":	
		...
		################################################
		## Read User area on FLASH and dump to a file ##
		################################################	
		
		## Dump flash user space to BINARY file (same format as on FLASH):
		...
		print "->" 	
		print "-> Reading user FLASH content and dumping it to a binary file..." 
		print "-> "
		print "-> Binary file:", bin_file.name			
		
		command = [readArray_comm]
		for i in reversed(range(lower_user_block, higher_user_block+1)):							
	...
	print "-> Syntax:"
	print "-> "
	print "-> glib_flash_user_prom_wr.py <file.mcs> <w|r>"
	print "-> "	
